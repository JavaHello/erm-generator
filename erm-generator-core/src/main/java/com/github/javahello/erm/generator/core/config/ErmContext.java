...
import com.github.javahello.erm.generator.core.internal.ErmIntrospector;
...
public class ErmContext extends Context {
    ...
    private ErmSourceConfiguration ermSourceConfiguration;
    ...
    public void introspectTables(ProgressCallback callback, List<String> warnings, Set<String> fullyQualifiedTableNames)
        ...
        ErmMetaData erms = getErmMetaData();

        ErmIntrospector databaseIntrospector = new ErmIntrospector(this, erms, javaTypeResolver, warnings);
    ...
    public ErmSourceConfiguration getErmSourceConfiguration() {
        return ermSourceConfiguration;
    }

    public void setErmSourceConfiguration(ErmSourceConfiguration ermSourceConfiguration) {
        this.ermSourceConfiguration = ermSourceConfiguration;
    }

    private ErmMetaData getErmMetaData() {
        return new ErmRead(ermSourceConfiguration);
    }
