 ...
 * @since 2018-01-10
 */
public abstract class ErmAbstractTemplateEngine {

    protected static final Logger logger = LoggerFactory.getLogger(ErmAbstractTemplateEngine.class);
    /**
     * 配置信息
     */
    private ErmConfigBuilder configBuilder;
     ...
     * 输出 java xml 文件
     */
    public ErmAbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                // 自定义内容
                ErmInjectionConfig injectionConfig = getConfigBuilder().getInjectionConfig();
     ...
     * 处理输出目录
     */
    public ErmAbstractTemplateEngine mkdirs() {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        ErmConfigBuilder config = getConfigBuilder();
    ...
    protected boolean isCreate(FileType fileType, String filePath) {
        ErmConfigBuilder cb = getConfigBuilder();
        // 自定义判断
        ErmInjectionConfig ic = cb.getInjectionConfig();
        if (null != ic && null != ic.getFileCreate()) {
            return ic.getFileCreate().isCreate(null, fileType, filePath);
        }
        // 全局判断【默认】
    ...
    public ErmConfigBuilder getConfigBuilder() {
        return configBuilder;
    }

    public ErmAbstractTemplateEngine setConfigBuilder(ErmConfigBuilder configBuilder) {
        this.configBuilder = configBuilder;
        return this;
    }
}
